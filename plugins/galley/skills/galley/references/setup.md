...
- `environment.yaml` proposal includes cwd, commands, implementation executor default, optional required-check shell, network/secrets/destructive-command constraints, PR creation, PR comment handling, base branch, and worktree cleanup.
