...
type AdapterEvidence struct {
	...
	SkeletonCheckpointResults []PreflightCheckpointResult `json:"skeleton_checkpoint_results,omitempty"`
}
...
func NewAdapterRequest(evidence Evidence) AdapterRequest {
	return AdapterRequest{Evidence: AdapterEvidence{
		...
		SkeletonCheckpointResults: evidence.SkeletonCheckpointResults,
	}}
}
